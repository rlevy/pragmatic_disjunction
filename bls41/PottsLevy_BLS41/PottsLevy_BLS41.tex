...
control the relative importance of conveying information about the
...
disjunction. Furthermore, $\SpeakerK[2]$ is more likely to say \AorX\
when observing $\tuple{\Lex_{2}, w_{1}}$ than under any other
circumstance. Together, these factors strongly push $\ListenerK[2]$ to
adopt a definitional construal of \AorX.  $\SpeakerK[3]$ follows suit,
strongly preferring to use the disjunction when in a definitional
state.
...
\begin{figure}[tp]
  ...
  \end{array}$
  \caption{Definitional inference, with only a subset of the states
