...
def add_vals(src_filename="countrycapitals.csv", 
    ...
    z1 = ZS(url="http://cpl-data.ucsd.edu/zs/google-books-20120701/eng-us-all/google-books-eng-us-all-20120701-1gram.zs")
    z2 = ZS(url="http://cpl-data.ucsd.edu/zs/google-books-20120701/eng-us-all/google-books-eng-us-all-20120701-2gram.zs")
    z3 = ZS(url="http://cpl-data.ucsd.edu/zs/google-books-20120701/eng-us-all/google-books-eng-us-all-20120701-3gram.zs")
    z4 = ZS(url="http://cpl-data.ucsd.edu/zs/google-books-20120701/eng-us-all/google-books-eng-us-all-20120701-4gram.zs")
    z5 = ZS(url="http://cpl-data.ucsd.edu/zs/google-books-20120701/eng-us-all/google-books-eng-us-all-20120701-4gram.zs")
    # Reader:
...
def get_ngram(target_ngram, db, first_year=1960):
    total = 0
    for line in db.search(prefix="%s\t" % target_ngram):
