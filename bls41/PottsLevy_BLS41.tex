...
\begin{figure}[tp]
  ...
  \begin{subfigure}{0.48\textwidth}
    ...
    \caption{With $\Costs(\word{or}) =1$, tracing four values of $\alpha$.}\label{fig:qsims:alphas}
  \end{subfigure}
  \hfill
  \begin{subfigure}{0.48\textwidth}
    \includegraphics[width=1\textwidth]{fig/Q-implicature-simulation-or} 
    \caption{With $\alpha=2$, tracing four values of $\Costs(\word{or})$.}\label{fig:qsims:or}
  \end{subfigure}
...
\begin{figure}[tp]
  ...
  \begin{subfigure}{0.48\textwidth}
    ...
    \caption{With $\Costs(\word{or}) =1$, tracing four values of $\alpha$.}\label{fig:isims:alphas}
  \end{subfigure}
  \hfill
  \begin{subfigure}{0.48\textwidth}
    \includegraphics[width=1\textwidth]{fig/I-implicature-simulation-or} 
    \caption{With $\alpha=2$, tracing four values of $\Costs(\word{or})$.}\label{fig:isims:or}
  \end{subfigure} 
