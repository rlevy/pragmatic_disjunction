...
\hypersetup{
  ...
  pdfkeywords={conversational implicatures, scalar implicatures, implicature blocking, disjunction, Hurford's constraint, Rational Speech Acts model}
}
...
hearing the general term (\word{boat}) to the more frequent subkind as
