...
\begin{abstract}
  ...
  as \word{boat or canoe}, can form part of a speaker strategy to
  ...
  term alone. Second, disjunctions of synonymous terms like \word{wine
    lover or \textbf{oenophile}} can be used to convey definitional
...
\seccitealt{Russell:2012}{5.3}); all of the examples marked as
...
like \word{lift or elevator} with an American colleague to signal a
willingness (or ironic lack thereof) to use the American form
\word{elevator}.\footnote{Our thanks to James Collins for bringing
...
the hypothetical academic paper title \word{What motivates the
  snobbish wine lover or `oenophile' and how does he differ from the
  casual drinker?}).
