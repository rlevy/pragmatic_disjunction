...
to be at odds with such uses.  In \tech{definitional disjunctions},
the speaker uses one disjunct to define the other, as in examples like
\word{wine lover or oenophile} and \word{oenophile or wine
  lover}. Such examples are striking because disjunction
